// AdminPrepaidPlansPage.jsx

import React, { useState, useEffect } from 'react';
import '../assets/css/AdminPrepaidPlansPage.css';

const AdminPrepaidPlansPage = () => {
  ...
  useEffect(() => {
    ...
    const mockData = [
      { id: 1, name: 'Basic Plan', data: '5 GB', price: '$10' },
      { id: 2, name: 'Standard Plan', data: '15 GB', price: '$20' },
  ...
  return (
    <div className="admin-prepaid-plans-container">
      <h2>Admin - Prepaid Plans</h2>
...
export default AdminPrepaidPlansPage;
